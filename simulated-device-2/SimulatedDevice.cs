...
namespace simulated_device
{
    class SimulatedDevice
    {
        ...
        // az iot hub device-identity connection-string show --hub-name {YourIoTHubName} --device-id MyDotnetDevice --output table
        private readonly static string s_connectionString = "HostName=myIoTHubPrClaseISS-worker-f.azure-devices.net;DeviceId=device1;SharedAccessKey=sAcRiohfFSTzxQ6mB381Ui/WeWSWcX2NeGQoXRblK9c=";
